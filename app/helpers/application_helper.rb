module ApplicationHelper
  def flash_class(level)
    case level
    when "notice" then "bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded relative"
    ...
    else "bg-gray-100 border border-gray-400 text-gray-700 px-4 py-3 rounded relative"
    end
  end
end
